...
export default function Api() {
  ...
  return (
    <>
    <h2 className="text-center text-bg-dark text-white rounded-2 ">Best Quotes That will Change your Life</h2>
      <div className="row">
        {quotes.map((res) => (
          <div className="col-6 col col-sm-6">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title text-center text-decoration-underline">{res.author}</h5>
                <p className="card-text text-center quotes">
                  {res.quote}
                </p>
              </div>
            </div>
